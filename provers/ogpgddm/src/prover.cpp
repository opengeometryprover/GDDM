...
DBinMemory Prover::ruleD42(DBinMemory dbim, std::string point1,
	...
	"WHERE (point1 = '" + point1 + "' AND point2 = '" + point2 + "' "
	+ "AND point3 = '" + point5 + "') "
	+ "OR (point1 = '" + point1 + "' AND point2 = '" + point5 + "' "
	+ "AND point3 = '" + point2 + "') "
	+ "OR (point1 = '" + point2 + "' AND point2 = '" + point1 + "' "
	+ "AND point3 = '" + point5 + "') "
	+ "OR (point1 = '" + point2 + "' AND point2 = '" + point5 + "' "
	+ "AND point3 = '" + point1 + "') "
	+ "OR (point1 = '" + point5 + "' AND point2 = '" + point1 + "' "
	+ "AND point3 = '" + point2 + "') "
	+ "OR (point1 = '" + point5 + "' AND point2 = '" + point2 + "' "
	+ "AND point3 = '" + point1 + "') ";
	...
	querySecondGeoCmdA = "SELECT * "
	    ...
	    + "OR (point1 = '" + point1 + "' AND point2 = '" + point5 + "' "
	    + "AND point3 = '" + point4 + "') "
	    + "OR (point1 = '" + point4 + "' AND point2 = '" + point1 + "' "
	    + "AND point3 = '" + point5 + "') "
	    + "OR (point1 = '" + point4 + "' AND point2 = '" + point5 + "' "
	    + "AND point3 = '" + point1 + "') "
	    + "OR (point1 = '" + point5 + "' AND point2 = '" + point1 + "' "
	    + "AND point3 = '" + point4 + "') "
	    + "OR (point1 = '" + point5 + "' AND point2 = '" + point4 + "' "
	    + "AND point3 = '" + point1 + "') ";
...
DBinMemory Prover::ruleD47(DBinMemory dbim, std::string point1,
	...
	"WHERE (point1 = '" + point1 + "' AND point2 = '" + point2 + "' "
	+ "AND point3 = '" + point4 + "') "
	+ "OR (point1 = '" + point1 + "' AND point2 = '" + point4 + "' "
	+ "AND point3 = '" + point2 + "') "
	+ "OR (point1 = '" + point2 + "' AND point2 = '" + point1 + "' "
	+ "AND point3 = '" + point4 + "') "
	+ "OR (point1 = '" + point2 + "' AND point2 = '" + point4 + "' "
	+ "AND point3 = '" + point1 + "') "
	+ "OR (point1 = '" + point4 + "' AND point2 = '" + point1 + "' "
	+ "AND point3 = '" + point2 + "') "
	+ "OR (point1 = '" + point4 + "' AND point2 = '" + point2 + "' "
	+ "AND point3 = '" + point1 + "') ";
 ...
 * ~ coll(A, B, C) and, eventually, searches for
 * eqangle(A, C, B, C, P, R, Q, R).
 */
DBinMemory Prover::ruleD58a(DBinMemory dbim, std::string point1,
			    std::string point2, std::string point3,
			    std::string point4, std::string point5,
			    std::string point6, std::string point7,
			    std::string point8) {
 ...
 *               & ~ coll(A, B, C) -> simtri(A, B, C, P, Q, R)
 *
 * Function's argument is eqangle(A, C, B, C, P, R, Q, R), verifies if
 * ~ coll(A, B, C) and, eventually, searches for
 * eqangle(A, B, B, C, P, Q, Q, R).
 */
DBinMemory Prover::ruleD58b(DBinMemory dbim, std::string point1,
			   std::string point2, std::string point3,
			   std::string point4, std::string point5,
			   std::string point6, std::string point7,
			   std::string point8) {
	...
	"WHERE (point1 = '" + point1 + "' AND point2 = '" + point2 + "' "
	+ "AND point3 = '" + point3 + "') "
	+ "OR (point1 = '" + point1 + "' AND point2 = '" + point3 + "' "
	+ "AND point3 = '" + point2 + "') "
	+ "OR (point1 = '" + point2 + "' AND point2 = '" + point1 + "' "
	+ "AND point3 = '" + point3 + "') "
	+ "OR (point1 = '" + point2 + "' AND point2 = '" + point3 + "' "
	+ "AND point3 = '" + point1 + "') "
	+ "OR (point1 = '" + point3 + "' AND point2 = '" + point1 + "' "
	+ "AND point3 = '" + point2 + "') "
	+ "OR (point1 = '" + point3 + "' AND point2 = '" + point2 + "' "
	+ "AND point3 = '" + point1 + "') ";
	// "WHERE point1 IN ('" + point1 + "', '" + point3 + "', '" + point2
	// + "') AND point2 IN ('" + point1 + "', '" + point3 + "', '" + point2
	// + "') AND point2 <> point1 AND point3 IN ('" + point1 + "', '" + point3
	// + "', '" + point2 + "') AND point3 NOT IN (point1, point2)";
    dbim.rc = sqlite3_prepare_v2(dbim.db, querySecondGeoCmdA.c_str(),
				 querySecondGeoCmdA.size(), &(dbim.stmt1),
				 NULL);
	...
	if (sqlite3_step(dbim.stmt) != SQLITE_DONE) {
		...
		"WHERE point1 = '" + point1 + "' AND point2 = '" + point3
		+ "' AND point3 = '" + point3 + "' AND point4 = '" + point2
		+ "' AND point5 = '" + point5 + "' AND point6 = '" + point7
		+ "' AND point7 = '" + point7 + "' AND point8 = '" + point6
		+ "'";
	    dbim.rc = sqlite3_prepare_v2(dbim.db, querySecondGeoCmdA.c_str(),
					 querySecondGeoCmdA.size(),
					 &(dbim.stmt1), NULL);
...
DBinMemory Prover::ruleD71(DBinMemory dbim, std::string point1,
	...
	"WHERE (point1 = '" + point1 + "' AND point2 = '" + point2 + "' "
	+ "AND point3 = '" + point3 + "' AND point4 = '" + point4 + "') "
	+ "OR (point1 = '" + point1 + "' AND point2 = '" + point2 + "' "
	+ "AND point3 = '" + point4 + "' AND point4 = '" + point3 + "') "
	+ "OR (point1 = '" + point2 + "' AND point2 = '" + point1 + "' "
	+ "AND point3 = '" + point3 + "' AND point4 = '" + point4 + "') "
	+ "OR (point1 = '" + point2 + "' AND point2 = '" + point1 + "' "
	+ "AND point3 = '" + point4 + "' AND point4 = '" + point3 + "') "
	+ "OR (point1 = '" + point3 + "' AND point2 = '" + point4 + "' "
	+ "AND point3 = '" + point1 + "' AND point4 = '" + point2 + "') "
	+ "OR (point1 = '" + point3 + "' AND point2 = '" + point4 + "' "
...
/*
 * Rule B1: cong(D, A, D, B) & midp(C, A, B)
 *               --> perp(A, B, C, D)
 *
 * Function's argument is cong(D,A,D,B) and searches for
 * midp(C, A,B).
 * 
 */
DBinMemory Prover::ruleB1cong(DBinMemory dbim, std::string point1,
			       std::string point2, std::string point3,
			       std::string point4) {
    bool correctTransaction;
    std::string insertionPred, insertNewFact, lastInsertedRowId, lstInsRwId;
    ...
    // DEBUG START
    //    std::cout << "===//ruleB1cong//===" << "\t";
    //    std::cout << point1+","+point2+","+point3+","+point4 << std::endl << std::flush;
    // DEBUG STOP
    ...
    // Look for the second conjunct in the new facts list
    querySecondGeoCmdA = "SELECT point1, point2, point3 "
	"FROM NewFact "
	"INNER JOIN Midpoint "
	"ON (newFact = id) "
    ...
    // DEBUG START
    //    std::cout << "querySecondGeoCmdA from NewFact" << std::endl;
    //    std::cout << querySecondGeoCmdA<< std::endl;
    // DEBUG STOP
	...
	//	std::cout  << "--- "<< (char*) sqlite3_column_text(dbim.stmt1, 0)  << "--- "<< std::endl;
	// DEBUG STOP
    }
    querySecondGeoCmdB = "SELECT point1, point2, point3 "
	"FROM Facts "
    ...
    dbim.rc = sqlite3_prepare_v2(dbim.db, querySecondGeoCmdB.c_str(),
				 ...
				 NULL);
    // DEBUG START
    //    std::cout << "querySecondGeoCmdB from Facts" << std::endl;
    //    std::cout << querySecondGeoCmdB << std::endl;
    // DEBUG STOP
    sqlite3_step(dbim.stmt2);
    if (sqlite3_data_count(dbim.stmt1) == 0
	&& sqlite3_data_count(dbim.stmt2) == 0 ) { // ambas a zero :(
    // DEBUG START
      //std::cout << "ambas a zero\n";
    // DEBUG STOP
      correctTransaction = false;
    } else {
      if (sqlite3_data_count(dbim.stmt1) != 0) { // uma delas é != zero :)
	newPoint1 = (char*) sqlite3_column_text(dbim.stmt1, 0);
	// DEBUG START
	//std::cout << "stmt1 não zero " << newPoint1 << "\n";
	// DEBUG STOP
      } else {
	newPoint1 = (char*) sqlite3_column_text(dbim.stmt2, 0);
	// DEBUG START
	//std::cout << "stmt2 não zero " << newPoint1 << "\n";
	// DEBUG STOP
      }
      if (point2 != newPoint1) {
	insertionPred = "INSERT INTO "
    ...
    if (correctTransaction) {
      sqlite3_exec(dbim.db, "commit;", 0, 0, 0);
      //      std::cout << "commit" << std::endl << std::flush;
      // DEBUG STOP
    }
    else {
      sqlite3_exec(dbim.db, "rollback;", 0, 0, 0);
      //      std::cout << "rollback" << std::endl << std::flush;
      // DEBUG STOP
    }
    return dbim;
}
 ...
 *               --> perp(A, B, C, D)
 *
 * Function's argument is midp(C, A, B) and searches for cong(D, A, D, B).
 */
DBinMemory Prover::ruleB1midp(DBinMemory dbim, std::string point1,
			       std::string point2, std::string point3) {
    bool correctTransaction;
    std::string insertionPred, insertNewFact, lastInsertedRowId, lstInsRwId;
    std::string querySecondGeoCmdA, querySecondGeoCmdB;
    ...
    // DEBUG START
    //    std::cout << "===//ruleB1midp//===\t";
    //std::cout << point1+","+point2+","+point3 << std::endl << std::flush;
    // DEBUG STOP
    ...
    // DEBUG STOP
      ...
      if (sqlite3_data_count(dbim.stmt1) != 0) {// uma delas é != zero :) 
	newPoint1 = (char*) sqlite3_column_text(dbim.stmt1, 1);
    // DEBUG START
	//	std::cout << "stmt1 não zero " << newPoint1 << "\n";
    // DEBUG STOP
      } else {
	newPoint1 = (char*) sqlite3_column_text(dbim.stmt2, 1);
    // DEBUG START
	//	std::cout << "stmt2 não zero " << newPoint1 << "\n";
    // DEBUG STOP
      }
...
DBinMemory Prover::fixedPoint(DBinMemory dbim, clock_t *proved_t) {
    ...
    // again and again, begin with value 1 (not proved), change to 0
	...
	case 3:
		...
		if (point1 != point3 && point1 != point4)
		    dbim = ruleD55perp(dbim, point1, point2, point3, point4);
	...
	case 4:
		...
		dbim = ruleB1midp(dbim, point1, point2, point3);
	    }
	    break;
	case 5:
	    // Circle
	...
	case 6:
		...
		if (point2 == point4) {
		  dbim = ruleB1cong(dbim, point1, point2, point3, point4);
		}
	    }
	    break;
	case 7:
		...
		&& (point1 != point4 || point2 != point5 || point3 != point6)) {
	...
	case 9:
		...
		&& (point1 != point3 || point2 != point4)
		&& (point1 != point4 || point2 != point3)
		&& (point5 != point7 || point6 != point8)
		&& (point5 != point8 || point6 != point7)) {
	...
	// to fix the time were the proof was attained
